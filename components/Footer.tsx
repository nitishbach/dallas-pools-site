    ...
    <footer className="bg-slate-950 text-slate-300">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              <p>
                <span className="text-slate-400">Location:</span> Dallas, TX
              </p>
              <p>
                <a
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                href="https://instagram.com/gulfbreeze.poolservice"
                target="_blank"
              ...
              <a
                href="https://facebook.com/gulfbreezepoolservice"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-white transition"
                aria-label="Facebook"
        ...
        <div className="border-t border-slate-800 pt-8 text-center text-sm text-slate-400">
          <p>
            © {new Date().getFullYear()} Gulf Breeze Pool Service. All rights
            reserved.
          </p>
        </div>
      </div>
